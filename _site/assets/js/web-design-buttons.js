function changeTextBlog() {
  ...
  if (x.innerHTML === "Blog") {
    ...
    document.getElementById("blog-circle").style.margin = "-0 50px";
  } else {
    x.innerHTML = "Blog";
    document.getElementById("blog").style.margin = "0";
    document.getElementById("blog-circle").style.padding = "50px 12px";
    document.getElementById("blog-circle").style.margin = "50px 100px";
  }
}
...
function changeTextStore() {
    ...
    if (x.innerHTML === "Store Front") {
      ...
      document.getElementById("store-circle").style.margin = "-0 50px";
    } else {
      ...
      document.getElementById("store-circle").style.margin = "50px 100px";
    }
  }
function changeTextGallery() {
    ...
    if (x.innerHTML === "Gallery") {
      ...
      document.getElementById("gallery-circle").style.margin = "-0 50px";
    } else {
      x.innerHTML = "Gallery";
      document.getElementById("gallery").style.margin = "0";
      document.getElementById("gallery-circle").style.padding = "50px 12px";
      document.getElementById("gallery-circle").style.margin = "50px 100px";
    }
  }
function changeTextPortfolio() {
  ...
  if (x.innerHTML === "Portfolio") {
    ...
    document.getElementById("portfolio-circle").style.margin = "-0 50px";
  } else {
    ...
    document.getElementById("portfolio-circle").style.margin = "50px 100px";
  }
}